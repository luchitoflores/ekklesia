...
function inicio(){
	...
	modelo_tablas('#id_table_log','#id_table_libro, #id_table_feligres,#id_table_matrimonio,#id_table_bautismo,#id_table_eucaristia,#id_table_confirmacion, #id_table_group, #id_table_parroquia, #id_table_provincia, #id_table_canton, #id_table_parroquia_civil');
	campos_con_fechas();
	radio_button();
